...
#!date:     2018-11-13
#!authors:  Mikukonai
#!cover:    ./image/assets/R/nuclear-plant.jpg
#!type:     原创
#!tags:     生物化学
...
![总的物质转化/能量转移路径](./image/assets/R/Catabolism-schematic.png)

![真核生物细胞呼吸模式图](./image/assets/R/Cellular_respiration_zh.jpg)

![真核生物细胞呼吸总览](./image/assets/R/CellRespiration.png)

![电子传递链](./image/assets/R/Electron-transport-chain.png)

# 首先复习一下有机化学

![这张图片我保存了大概有十多年了，出处已经不可考，Google图片检索也查不到](./image/assets/R/organic-reactions.gif)
...
|名称|结构|说明|
|-------------|
|乙酰辅酶A|<img src="./image/assets/R/Acetyl-CoA.png" style="max-width:150px;"><br>[查看原图](./image/assets/R/Acetyl-CoA.png)|乙酰辅酶A（acetyl-CoA）可以视为激活了的乙酸。乙酰辅酶是丙酮酸脱羧、脂肪酸β-氧化的产物。三大营养物质的彻底氧化殊途同归，都会生成乙酰辅酶A以进入三羧酸循环。|
|草酰乙酸|HOOC-CO-CH<sub>2</sub>-COOH||
|柠檬酸|<img src="./image/assets/R/Citric-acid.png" style="max-width:150px;">|柠檬酸（枸橼酸）是一种中强度有机酸。柠檬酸是在柑橘类水果中自然产生的一种天然防腐剂，也是食物和饮料中的酸味添加剂。柠檬和青柠含有大量柠檬酸，在干燥之后，含量可达8%。|
|顺乌头酸|<img src="./image/assets/R/Cis-aconitic-acid.png" style="max-width:150px;">|柠檬酸脱水产物，因此又叫焦柠檬酸。|
|异柠檬酸|<img src="./image/assets/R/Isocitric-acid.png" style="max-width:150px;">|异柠檬酸常被作为检测水果类产品特别是柑橘类果汁真假和质量的一个指标。例如，在正宗的橙汁中柠檬酸量与D-异柠檬酸之间的比率通常小于130，如果异柠檬酸值比这个高的话就可能表示这是搀假货。|
|α-酮戊二酸|<img src="./image/assets/R/Alpha-ketoglutaric-acid.png" style="max-width:150px;">||
|琥珀酰辅酶A|<img src="./image/assets/R/Succinyl-CoA.png" style="max-width:150px;">||
|琥珀酸|HOOC-CH<sub>2</sub>-CH<sub>2</sub>-COOH|即丁二酸|
|延胡索酸|HOOC-CH=CH-COOH|即反丁烯二酸|
|L-苹果酸|<img src="./image/assets/R/Malic-acid.png" style="max-width:150px;">||

## 反应步骤

### 1.草酰乙酸+乙酰辅酶A→柠檬酸

![ΔG°′ = −31,4 kJ/mol](./image/assets/R/CAC1.png)

### 2.柠檬酸⇌顺乌头酸⇌异柠檬酸

![ΔG°′ = +6,3 kJ/mol](./image/assets/R/CAC2.png)

### 3.异柠檬酸氧化脱羧→α-酮戊二酸

![ΔG°′ = −8,4 kJ/mol](./image/assets/R/CAC3.png)

### 4.α-酮戊二酸氧化脱羧→琥珀酰辅酶A

![ΔG°′ = −30,1 kJ/mol](./image/assets/R/CAC4.png)

### 5.琥珀酰辅酶A经底物水平磷酸化→琥珀酸

![ΔG°′ = −33,5 kJ/mol](./image/assets/R/CAC5.png)

### 6.琥珀酸脱氢⇌延胡索酸

![ΔG°′ = 0 kJ/mol](./image/assets/R/CAC6.png)

### 7.延胡索酸加水⇌苹果酸

![ΔG°′ = −3,8 kJ/mol](./image/assets/R/CAC7.png)

### 8.苹果酸脱氢⇌草酰乙酸

![ΔG°′ = +29,7 kJ/mol](./image/assets/R/CAC8.png)

### 概览

![ ](./image/assets/R/Citric-acid-cycle.png)

## 添补反应

## 调控与抑制

![ ](./image/assets/R/metabolization-relation.png)
...
![ ](./image/assets/R/respiratory-chain-structure.png)
...
![NAD<sup>+</sup>](./image/assets/R/NAD.png)
...
![NAD<sup>+</sup>的加氢和脱氢反应](./image/assets/R/NAD+H.png)

#### 核黄素系列

黄素蛋白种类很多，辅基有两种：FMN（黄素单核苷酸）和FAD（黄素腺嘌呤二核苷酸），均含有异咯嗪基团（维生素B2）。异咯嗪基团可以渐次结合/脱去两个氢。

![FMN的加氢和脱氢反应](./image/assets/R/FMN+H.png)
...
![铁硫蛋白中铁硫中心的结构](./image/assets/R/Fe-S-center.png)
...
![UQ的加氢和脱氢反应](./image/assets/R/UQ+H.png)

#### 血红素系列

![ ](./image/assets/R/Cyt-a-b-cofactor.png)

![ ](./image/assets/R/Cyt-c-cofactor.png)
...
![复合体Ⅰ工作机制：一、七个主要的铁硫中心可将电子从NADH转移到UQ。注意在真核生物中没有发现N7。二、CoQ被还原为CoQH<sub>2</sub>。三、氧化还原反应提供的能量导致构象变化，使得氢离子通过4个螺旋状的跨膜通道。（图及图注来自维基百科）](./image/assets/R/NADH-Dehydrogenase-Mechanism.jpg)
...
![复合体Ⅱ工作机制（图片来自维基百科）](./image/assets/R/Succinate-Dehydrogenase.jpg)
...
![复合体Ⅲ工作机制（图片来自维基百科）](./image/assets/R/Complex-III.jpg)
...
![ ](./image/assets/R/Complex_IV.png)

![ ](./image/assets/R/Complex-4.png)

![质子泵和电子转移模式](./image/assets/R/Complex-4-Cycle.png)

![ ](./image/assets/R/Complex-4-O2.png)

![ ](./image/assets/R/Cu-A.png)

![ ](./image/assets/R/Cu-B.png)

## ATP合酶——合成ATP的分子马达

参见维基百科：[ATP合酶](https://de.wikipedia.org/wiki/ATP-Synthase)

![点亮您生命的火 火火火火火](./image/assets/R/ATP-synthase.gif)
...
![ ](./image/assets/R/ORP-in-RespChain.png)

### 偶联机制

![ ](./image/assets/R/chemiosmetic-theory.png)
