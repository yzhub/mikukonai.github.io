...
![真正的λ函数，即便没有名字，也能求出他的值。（画师：infinote，PixivID：54853954）](./image/assets/D/iwazaru.jpg)
...
![余弦函数的不动点](./image/assets/C/cos_fixed_point.jpg)
...
![你的名字？](./image/assets/J/omaedare.jpg)
